...
public class User {
	...
	//A single user can post multiple posts
	@OneToMany
	...
	private byte[] profilePic; //For storing photo in mysql use byte to have PNG images
	...
	//Important(To send the image in Base64 format)
